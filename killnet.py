...
╚═══>\033[95m """)
        ...
        if proxy == None:
                while True:
                        ...
                        req7 = r.get("https://raw.githubusercontent.com/Xandermercado800/Proxy/main/proxy.txt").text
                        req8 = r.get("https://raw.githubusercontent.com/ZOXXX906/japan_ddoser/main/socks5.txt").text
